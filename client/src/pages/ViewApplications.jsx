...
const ViewApplications = () => {
  ...
  //Functio to fetch company job Application data
  ...
  //Function to change the job application status
  ...
  return applicants ? applicants.length ===0 ?      (  <div className='flex items-center justify-center h-[70vh]'>
    <p className='text-xl sm:text-2xl'>No Applications Avliable</p>
  </div>) : (
            ...
            {applicants.filter(item =>  item.jobId && item.userId).map((applicant,index)=>(
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b '>
                  <a className="bg-blue-50 text-blue-400 px-3 py-1 inline-flex rounded gap-2 items-center "href={applicant.userId.resume} target='_blank'>Resume <img src={assets.resume_download_icon} alt="" /></a>
                </td>
